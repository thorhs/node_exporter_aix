...
void gather_filesystems(std::ostringstream& response, const std::string& static_labels) {
	...
	for(auto it = filesystems.begin(); it < filesystems.end(); it++) {
		response << "node_filesystem_size_bytes{device=\"" << (*it).device << "\",fstype=\"" << (*it).fstype << "\",mountpoint=\"" << (*it).mountpoint << "\"," << static_labels << "} " << (*it).size_bytes << std::endl;
	}
	...
	for(auto it = filesystems.begin(); it < filesystems.end(); it++) {
		response << "node_filesystem_free_bytes{device=\"" << (*it).device << "\",fstype=\"" << (*it).fstype << "\",mountpoint=\"" << (*it).mountpoint << "\"," << static_labels << "} " << (*it).free_bytes << std::endl;
	}
	...
	for(auto it = filesystems.begin(); it < filesystems.end(); it++) {
		response << "node_filesystem_avail_bytes{device=\"" << (*it).device << "\",fstype=\"" << (*it).fstype << "\",mountpoint=\"" << (*it).mountpoint << "\"," << static_labels << "} " << (*it).avail_bytes << std::endl;
	}
	...
	for(auto it = filesystems.begin(); it < filesystems.end(); it++) {
		response << "node_filesystem_files{device=\"" << (*it).device << "\",fstype=\"" << (*it).fstype << "\",mountpoint=\"" << (*it).mountpoint << "\"," << static_labels << "} " << (*it).files << std::endl;
	}
	...
	for(auto it = filesystems.begin(); it < filesystems.end(); it++) {
		response << "node_filesystem_files_free{device=\"" << (*it).device << "\",fstype=\"" << (*it).fstype << "\",mountpoint=\"" << (*it).mountpoint << "\"," << static_labels << "} " << (*it).files_free << std::endl;
	}
	...
	for(auto it = filesystems.begin(); it < filesystems.end(); it++) {
		response << "node_filesystem_files_avail{device=\"" << (*it).device << "\",fstype=\"" << (*it).fstype << "\",mountpoint=\"" << (*it).mountpoint << "\"," << static_labels << "} " << (*it).files_avail << std::endl;
	}
}
